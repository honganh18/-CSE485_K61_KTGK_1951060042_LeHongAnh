...
?>
    ...
    <main>
        ...
        <!-- Quy trình 4 bước -->
        <a href="addPatient.php" class="btn btn-success"><i class="fas fa-user-plus"></i> Thêm Bệnh Nhân</a>
        <table class="table">
            <thead>
                <tr>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result)>0){
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            echo '<td><a href="process_deletePatient.php?id='.$row['patientid'].'"><i class="fas fa-user-times"></i></a></td>';
                            echo '</tr>';
                        }
                    }
                ?>
